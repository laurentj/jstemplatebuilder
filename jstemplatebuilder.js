...
jsTemplateBuilder.prototype = {
    ...
    */
    ...
    build: function(tplUrl, DOMtarget, clean){
        ...
        try{
            ...
            // we have an object in DOMtarget : we assume that it is a DOM element object
                ...
                throw "invalid DOMtarget";
            }
        }catch(e){
            this.errors = e.toString();
            if(!this.errorSilent){
                throw 'jsTemplateBuilder : '+tplUrl+ ' : '+ e.toString();
            }
            return false;
        }
        return true;
                ...
                switch(tag.localName){
                    ...
                    case 'attribute':
                        ...
                        if(assignation[0] && assignation[1])
                           ...
                           throw "attribute in attribute tag are missing";
                        break;
                    ...
                    case 'foreach':
                        ...
                        if(from && item){
                            ...
                            if(typeof(fromvar) != 'undefined'){
                              for (var keyname in fromvar) {
                               ...
                               throw 'unknow "from" value in foreach';
                        }else{
                          throw "not enough attribute in foreach tag ";
                        }
                        break;
                     ...
                     case 'assign':
                        ...
                        if(name && value){
                          ...
                          throw "not enough attribute in assign tag";
                        }
                        break;
                     ...
                     case 'debug':
                        ...
                        if(what){
                          ...
                          throw "show attribute missing in debug tag";
                        }
                        break;

                     default:
                         throw "unknow template tag : " + tag.localName;
               }
    ...
    _clean: function (elt){
         if(!elt)
            throw 'clean: invalide root element';
         var i;
